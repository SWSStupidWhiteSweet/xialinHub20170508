$(function($) {
	...
	$("#audit").click(function(){
		...
		if (Common.isEmpty(selectedRowsId) || selectedRowsId.length <= 0) {
			window.parent.reviewIndex.messageBox("提示", "请选择一条你想审核的数据！", false);
			return false;
		}

		var rowData = Common.jqGridGetRowData(gridSelector, selectedRowsId);
		window.parent.location.href = "reviewaudit?orderInfoId="+rowData.orderInfoId;
	});
	/** **************************************按钮事件 end *************************************** */
});