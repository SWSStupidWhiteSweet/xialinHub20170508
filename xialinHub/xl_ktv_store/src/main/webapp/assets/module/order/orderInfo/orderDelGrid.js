$(function($) {
	...
	var jqGridOption = new Common().createGridOption({
		...
		title : "订单列表",
		url : "getgriddata",
		postData : {dataStatus:'N'},
		multiSelect : true,
		height : "450",
		sortName : "modify_time",
		sortOrder : "desc",
		colNamesArray : [ '订单记录ID', '订单号', '客户姓名', '客户手机', '项目名称', '城市', '套餐类型', '渠道归属','报备人','所属经纪公司','所属经纪门店','联代方','订单状态',
		                  '认购房源楼栋','单元','房号','应收电商费','已收电商费','应收回款','已收回款','创建时间','到访时间','审核状态','指纹'],
		colModel : [ {
			name : "orderInfoId",
			index : "order_info_id",
			width : 60,
