$(function($) {
	...
	var jqGridOption = new Common().createGridOption({
		...
		colNamesArray : [ '订单ID','催收ID','订单号','电商项目','客户姓名', '结佣公司', '结佣门店', '所属城市', '佣金类型', '已结佣金',
				'结佣帐号', '退款审核人', '退款审核时间', '已追回佣金', '剩余追回佣金'],
		colModel : [ {
			name : "order_info_id",
			index : "order_info_id",
			width : 60,
	 ...
	 * 导出
	 */
	$("#excelrecoverwaitlist").click(
			function() {
				location.href = "excelrecoverwaitlist?province="
	...
	$("#receivables").click(function() {
		...
		window.parent.location.href = "toreceivables?brokerageType="
