$(function($) {
    ...
    $("#export").click(function(){
    	...
    	location.href="notrecoveryexport?mark=6&&data="+JSON.stringify(params);
    });
	...
	$("#receiveRegain").click(function() {
	    ...
	    window.parent.location.href="editreceiveregain?position=receiveRegain&data="+JSON.stringify(params);
	});
